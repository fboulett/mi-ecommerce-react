            ...
            <div className={style.footerContent}>
                <div className={style.teamIcons}>
                    <div className={style.teamMember}>
                        <img src="/images/MESSI.png" alt="Integrante 1" className={style.teamIcon} />
                        <p className={style.teamDescription}>Capitán del equipo</p>
                    </div>
                    <div className={style.teamMember}>
                        <img src="/images/musk.png" alt="Integrante 2" className={style.teamIcon} />
                        <p className={style.teamDescription}>Tech Leader</p>
                    </div>
                    <div className={style.teamMember}>
                        <img src="/images/jenseng.png" alt="Integrante 3" className={style.teamIcon} />
